...
void handle_connections(int sock, int port) {
  ...
  // #Answer - In production it's a bad practice so we should add a condition to break the loop and close the server socket gracefully.
  while (true) {
...
int main() {
  ...
  // #Answer - Yes, a name like initinitialize_server would be more descriptive
